...
for i in names:
    ...
    data['   metrics/precision(B)'] = data['   metrics/precision(B)'].fillna(
        data['   metrics/precision(B)'].interpolate())
...
for i in names:
    ...
    data['      metrics/recall(B)'] = data['      metrics/recall(B)'].fillna(
        data['      metrics/recall(B)'].interpolate())
...
for i in names:
    ...
    data['       metrics/mAP50(B)'] = data['       metrics/mAP50(B)'].fillna(
        data['       metrics/mAP50(B)'].interpolate())
...
for i in names:
    ...
    data['    metrics/mAP50-95(B)'] = data['    metrics/mAP50-95(B)'].fillna(
        data['    metrics/mAP50-95(B)'].interpolate())
...
for i in names:
    ...
    data['         train/box_loss'] = data['         train/box_loss'].fillna(
        data['         train/box_loss'].interpolate())
...
for i in names:
    ...
    data['         train/dfl_loss'] = data['         train/dfl_loss'].fillna(
        data['         train/dfl_loss'].interpolate())
...
for i in names:
    ...
    data['         train/cls_loss'] = data['         train/cls_loss'].fillna(
        data['         train/cls_loss'].interpolate())
...
for i in names:
    ...
    data['           val/box_loss'] = data['           val/box_loss'].fillna(
        data['           val/box_loss'].interpolate())
...
for i in names:
    ...
    data['           val/dfl_loss'] = data['           val/dfl_loss'].fillna(
        data['           val/dfl_loss'].interpolate())
...
for i in names:
    ...
    data['           val/cls_loss'] = data['           val/cls_loss'].fillna(
        data['           val/cls_loss'].interpolate())
