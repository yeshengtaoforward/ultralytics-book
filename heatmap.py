...
class yolov8_heatmap:
    ...
    def post_process(self, result):
        result = non_max_suppression(result, conf_thres=self.conf_threshold, iou_thres=0.50)[0]
        return result
...
def get_params():
    params = {
        'weight': r'C:\ultralytics-main2\ultralytics-main\Book.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'RandomCAM',
...
if __name__ == '__main__':
    ...
    model(r'C:\ultralytics-main\text03.jpg', 'result')
